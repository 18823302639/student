<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\myphp_www\WWW\Student\public/../application/admin\view\admin\index.html";i:1553501551;s:64:"D:\myphp_www\WWW\Student\application\admin\view\layout\base.html";i:1553679789;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="#">切换账户</a></li>
                            <li><a href="#" onclick="unlogin()">退出</a></li>
                        </ul>
                    </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            <dt><i class="Hui-iconfont">&#xe616;</i> 作业模块<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('task/article_list'); ?>" data-title="查看作业"  href="javascript:void(0)">查看作业</a></li>
                    <li><a data-href="article-list.html" data-title="发布作业"  href="javascript:void(0)">发布作业</a></li>
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('course/teacher_list'); ?>" data-title="图片管理" href="javascript:void(0)">授课老师</a></li>
                    <li><a data-href="<?php echo url('course/course_list'); ?>" data-title="所有课程" href="javascript:void(0)">所有课程</a></li>
